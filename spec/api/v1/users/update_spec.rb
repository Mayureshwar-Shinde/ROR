  ...
  describe 'PUT #update' do
    ...
    context 'with valid parameters' do
      it 'updates the user' do
        put "/api/v1/users/#{@user.id}", params: valid_attributes, headers: { 'Authorization' => token.value }
        @user.reload
    ...
    context 'with the invalid parameters' do
      it 'returns a not found error' do
        put '/api/v1/users/9999', params: { user: { first_name: 'NonExistent' } }, headers: { 'Authorization' => token.value }
