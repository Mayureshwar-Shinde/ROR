...
RSpec.feature 'Avatar management', type: :feature do
  ...
  image_path = 'app/assets/images/dispute_analyst_avatar.png'

  subject do
    attach_file('dispute_analyst[avatar]', Rails.root.join(image_path))
  ...
  context 'Avatar Updation' do
    ...
    scenario 'User cannot update avatar with an invalid image format' do
      image_path = 'spec/features/dispute_analysts/avatar/invalid_avatar.txt'
      subject
  ...
  context 'Avatar Deletion' do
    scenario 'User cannot update avatar with an image exceeding the maximum dimensions' do
      image_name = 'spec/features/dispute_analysts/avatar/large_image.png'
      subject
