...
RSpec.feature "New Registration management", type: :feature do
  ...
  subject do
    ...
    fill_in 'First name', with: dispute_analyst.first_name
    fill_in 'Last name', with: dispute_analyst.last_name
    fill_in 'Age', with: dispute_analyst.age
    fill_in 'Date of birth', with: dispute_analyst.date_of_birth
    fill_in 'Email', with: 'tracy@jonas.com'
    fill_in 'Password', with: dispute_analyst.password
    fill_in 'Password confirmation', with: dispute_analyst.password
  end
  ...
  context "with duplicate email" do
    let!(:existing_user) { create(:dispute_analyst, email: 'duplicate@example.com') }
