class CaseManagers::CommunicationsController < ApplicationController
  ...
  def create
    ...
    if @communication.save
      ...
      redirect_to case_managers_case_path(params[:id]), notice: 'Communication sent successfully'
    else
      @errors = @communication.errors.full_messages.to_sentence
      redirect_to new_case_managers_communication_path(message_type: @message_type), alert: @errors
    end
  end
